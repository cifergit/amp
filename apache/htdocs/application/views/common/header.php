<header class="header">
    <nav class="mod_inner">
        <ul id="topNavWrap">
            <li class="top-nav-li <?php if($currentNav == ''){echo 'top-nav-li--active';}?>" title="太空船"><a href="//www.boatsky.com">太空船</a></li>
            ...
            <?php if(!empty($uid) && !empty($uname) && !empty($ukey)){?>
                <li class="top-nav-li <?php if($currentNav == 'user'){echo 'top-nav-li--active';}?>" title="用户"><a href="//www.boatsky.com/user.html"><?php echo $uname;?></a></li>
            <?php }else {?>
                <li class="top-nav-li <?php if($currentNav == 'login'){echo 'top-nav-li--active';}?>" title="登录"><a href="//www.boatsky.com/login.html">登录</a></li>
            <?php }?>
